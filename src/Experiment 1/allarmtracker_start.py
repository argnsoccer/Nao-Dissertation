...
def main(IP, PORT, ballSize, effector):
    ...
    print "Torso Frame Target Position: " + tracker.getTargetPosition(0)
    print "World Frame Target Position: " + tracker.getTargetPosition(1)
    print "Robot Frame Target Position: " + tracker.getTargetPosition(2)
